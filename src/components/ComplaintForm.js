// ============================================
// ComplaintForm.js
// Form to submit new complaints with photo evidence
...
function ComplaintForm() {
    ...
    const handlePhotoChange = (e) => {
        ...
        // Read as Base64 for preview and storage
            ...
            <div className="form-card">
                <div className="form-header">
                    ...
                    <p className="form-subtitle">
                        ...
                        <br />
                        <strong>📸 Photo evidence required for verification</strong>
                    </p>
                </div>
                    ...
                    <div className="success-card">
                        ...
                        <div className="result-grid">
                            <div className="result-item">
                                ...
                                <span className="result-value">#{success.id}</span>
                            </div>
                            <div className="result-item">
                            ...
                            <div className="result-item">
                                ...
                                <span className="result-value">{success.confidence}</span>
                            </div>
                            <div className="result-item">
                                ...
                                <span className={`badge verify-${success.verificationStatus}`}>
                                    {success.verificationStatus === 'VERIFIED'
                                        ? '✅ VERIFIED'
                                        : success.verificationStatus === 'UNVERIFIED'
                                        ? '⚠️ UNVERIFIED'
                                        : '❌ NO PHOTO'}
                                </span>
                            </div>
